...
public class Listar {
    ...
    public Listar(JTextArea textArea) {
        this.textArea = textArea;
    }
    
    public void listOrders(JTextArea textArea){       
    ...
    public void listDetails(JTextArea textArea){       
        Dba db = new Dba("./TenRecord.accdb");
        db.conectar();
        try {
    ...
    public void listCustomers(JTextArea textArea){       
        Dba db = new Dba("./TenRecord.accdb");
        db.conectar();
        try {
    ...
    public void listProducts(JTextArea textArea){       
        Dba db = new Dba("./TenRecord.accdb");
        db.conectar();
        try {
